...
public class ExcelImporterMaker : EditorWindow
{
        ...
        foreach (UnityEngine.Object obj in Selection.objects)
        {
            ...
            using (FileStream stream = File.Open (window.filePath, FileMode.Open, FileAccess.Read))
            {
                ...
                for (int i=0; i < titleRow.LastCellNum; i++)
                {
					...
					if (cell.CellType != NPOI.SS.UserModel.CellType.Unknown && cell.CellType != NPOI.SS.UserModel.CellType.BLANK)
                    {
    ...
    void ExportEntity()
    {
        string templateFilePath = (sepalateSheet) ? "Assets/Editor/EntityTemplate2.txt" : "Assets/Editor/EntityTemplate.txt";
    ...
    void ExportImporter()
    {
        string templateFilePath = (sepalateSheet) ? "Assets/Editor/ExportTemplate2.txt" : "Assets/Editor/ExportTemplate.txt";
