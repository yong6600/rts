...
public class SoundManager : SingletonMonobehaviour<SoundManager>
{
    ...
    private void Start()
    {
        ...
        if(this.mixer != null)
        {
            ...
            {
                Debug.Log("this.effect_audios.Length :" + this.effect_audios.Length);
                Debug.Log("EffectGroupName :" + mixer.FindMatchingGroups(EffectGroupName)[0]);
    ...
    {
        currentRatio = Mathf.Clamp01(currentRatio); // 0 ~ 1로 셋팅
    ...
    private void Update()
    {
        ...
        if(this.fadeA_audio.isPlaying == true && fadeB_audio.isPlaying == false)
        {
            this.currentPlayingType = MusicPlayingType.SourceA;
        }else if(this.fadeB_audio.isPlaying == true && this.fadeA_audio.isPlaying ==false)
        {
            this.currentPlayingType = MusicPlayingType.SourceB;
        }else if(this.fadeA_audio.isPlaying == false && this.fadeB_audio == false)
        {
    ...
    {
        Debug.Log("DataManger Sound:" + DataManager.Sound().GetCopy(index));
